...
toystory = parents.Movie("Toy Story",
                         "Andy's favourite toy, Woody, is worried that after Andy receives his birthday gift, a new toy called Buzz Lightyear, his importance may get reduced.",
...
school_of_rock = parents.Movie("School Of Rock",
                               "Dewey Finn, an amateur rock enthusiast, slyly takes up his friend's substitute teacher's job. Bearing no qualifications for it, he instead starts training the students to be a band.",
                               "https://images-na.ssl-images-amazon.com/images/I/51XB8K6WPEL._SY445_.jpg",
                               "https://www.youtube.com/watch?v=3PsUJFEBC74")

hungergames = parents.Movie("Hunger Games",
...
angels_and_demons = parents.Movie("Angels and Demons",
                                  "A symbologist tries his best to stop a secret society from destroying Vatican City. He tries to decipher various clues in the process, most of which lead him to the four altars of science.",
                                  "https://upload.wikimedia.org/wikipedia/en/thumb/4/44/Angels_and_demons.jpg/220px-Angels_and_demons.jpg",
                                  "https://www.youtube.com/watch?v=dhMQVeL8Kqw")

titanic = parents.Movie("Titanic",
...
red_sparrow = parents.Movie("Red Sparrow",
...
death_wish = parents.Movie("Death Wish",
                           ...
                           "https://www.dvdsreleasedates.com/posters/800/D/Death-Wish-2017-movie-poster.jpg",
...
#passing the list as a parameter to the 'open_movies_page' method inside 'fresh_tomatoes.py'
